...
public class SquareGridCalculator {
    ...
    private double ordinateOfBalanceSheet() {
        ...
        double oneSquareOrdinate = 0, twoSquaresOrdinate = 0, fourSquaresOrdinate = 0;
        Boolean xCurb, yCurb;
        ...
        for (int j = 0; j < sizeY; j++) {
            for (int i = 0; i < sizeX; i++) {
                ...
                if (xCurb || yCurb) {
                    if (xCurb && yCurb) {
                        oneSquareOrdinate += squareGrid.squareCorners[i][j].terrainOrdinate;
                    } else {
        ...
        finalOrdinate = (1 / (4 * amountOfSquare)) * (oneSquareOrdinate + 2 * twoSquaresOrdinate + 4 * fourSquaresOrdinate);
